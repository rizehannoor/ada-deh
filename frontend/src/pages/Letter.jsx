...
const lines = [
  "btw...",
  "aku sadar akhir-akhir ini aku jarang banget ngabarin kamu.",
  "bukan karena lupa.",
  "aku cuma lagi nahan diri buat nggak banyak cerita dulu.",
  "soalnya ada sesuatu yang lagi aku siapin.",
  "dan rasanya lebih seru kalau kamu tahu pas waktunya.",
  "jadi selama ini kalau aku agak diem...",
  "bukan berarti aku lupa sama kamu.",
];
