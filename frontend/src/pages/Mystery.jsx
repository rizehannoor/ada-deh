...
const lines = [
  "aku nggak akan bilang ini web apa.",
  "biar kamu yang nyari tau sendiri.",
  "tapi aku janji...",
  "...ini bukan jahilin kamu lagi kok",
];

export default function Mystery({ onNext }) {
  ...
  return (
    <section className="scene scene-mystery">
